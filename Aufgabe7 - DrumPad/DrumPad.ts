...
function playSample(sound:String) {
    if(sound == "Kick"){
        var sound1:HTMLAudioElement = new Audio('kick.mp3');
    sound1.play();
    }
    
    else if(sound == "Snare"){
        var sound2:HTMLAudioElement = new Audio('snare.mp3');
        sound2.play();
    }
    
    else if(sound == "HiHat"){
    var sound3:HTMLAudioElement = new Audio('hihat.mp3');
    sound3.play();
    }

    else if(sound == "C"){
        var sound3:HTMLAudioElement = new Audio('C.mp3');
        sound3.play();
        }
        ...
        var sound3:HTMLAudioElement = new Audio('G.mp3');
        sound3.play();
        }
    
    else if(sound == "A"){
        var sound3:HTMLAudioElement = new Audio('A.mp3');
        sound3.play();
        }

    else if(sound == "Laugh1"){
        var sound3:HTMLAudioElement = new Audio('laugh-1.mp3');
        sound3.play();
        }

    else if(sound == "Laugh2"){
        var sound3:HTMLAudioElement = new Audio('laugh-2.mp3');
        sound3.play();
        }
}
