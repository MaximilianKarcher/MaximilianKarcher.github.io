...
window.addEventListener("load", function(): void {
    ...
    document.querySelector("#HiHat").addEventListener("click", function(): void {  playSample("HiHat"); });
 
    document.querySelector("#C").addEventListener("click", function(): void {  playSample("C");  });   
   
    document.querySelector("#F").addEventListener("click", function(): void {  playSample("F"); });
    
    document.querySelector("#G").addEventListener("click", function(): void {  playSample("G");  });

    document.querySelector("#A").addEventListener("click", function(): void { playSample("A");  });
   
    document.querySelector("#Laugh1").addEventListener("click", function(): void {  playSample("Laugh1"); });
    
    document.querySelector("#Laugh2").addEventListener("click", function(): void {   playSample("Laugh2"); });
